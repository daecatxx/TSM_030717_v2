...
namespace TimeSheetManagementSystem.APIs
{
    ...
    public class UserManagerController : Controller
    {
        ...
        public async Task<IActionResult> Put(string id, [FromBody]string value)
        {
            ...
            newUser.FullName = Convert.ToString(userNewInput.fullName.Value).ToUpper();

            // Convert.ToString(categoryNewInput.categoryName.Value).ToUpper();
            newUser.Email = Convert.ToString(userNewInput.email.Value).ToUpper();
